...
{
    public class PremiumPaymentService : PaymentServiceProvider
    {
        public override bool FulfillPayment(CreditCard creditCard, int retryAttempts)
        {
            if (CheckServiceAvailability())
            {
                ...
                {
                    string failureReason = "PremiumPaymentService System error while wiring monney";
            ...
            {
                string failureReason = "PremiumPaymentService is unavailable at the moment.";
                SignalPaymentFailure(creditCard, failureReason);
                return false;
            }
        }
